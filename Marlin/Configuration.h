...
#define STRING_CONFIG_H_AUTHOR "(Anand Bosco, ADIMLab Gantry-S)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Gantry-S"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // My Printer (from PID Auto tune)
  //M301 P36.06 I4.79 D67.93
  #define DEFAULT_Kp 36.06
  #define DEFAULT_Ki 4.79
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //My Printer (from PID Auto tune)
  //M304 P185.45 I36.14 D634.35
  #define DEFAULT_bedKp 185.45
  #define DEFAULT_bedKi 36.14
  #define DEFAULT_bedKd 634.35
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4[, E5]]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 8, 80 }
...
//This to prevent fan pwn signal routed to servo pin and vice versa, HAL bug may be.
#define FAN_SOFT_PWM 
